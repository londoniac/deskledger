  ...
  return (
    <div style={{ maxWidth: 700 }}>
      ...
      <Card style={{ marginBottom: 20 }}>
        <h3 style={{ fontSize: 15, fontWeight: 600, color: PALETTE.text, marginBottom: 20 }}>Company Details</h3>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <div style={{ gridColumn: "1 / -1" }}>
            <Label>Company Name</Label>
            <Input value={form.company_name} onChange={(e) => update("company_name", e.target.value)} placeholder="Your Ltd Company" />
          </div>
          <div>
      ...
      {/* Financial Year */}
      <Card style={{ marginBottom: 20 }}>
        <h3 style={{ fontSize: 15, fontWeight: 600, color: PALETTE.text, marginBottom: 20 }}>Financial Year</h3>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <div>
      ...
      <Card style={{ marginBottom: 20 }}>
        ...
        <label style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", marginBottom: form.vat_registered ? 16 : 0 }}>
          <div
            onClick={() => update("vat_registered", !form.vat_registered)}
            style={{
              width: 40, height: 22, borderRadius: 11, cursor: "pointer",
              background: form.vat_registered ? PALETTE.accent : PALETTE.border,
              position: "relative", transition: "background 0.2s",
            }}
          >
            <div style={{
              width: 18, height: 18, borderRadius: 9, background: "#fff",
              position: "absolute", top: 2, left: form.vat_registered ? 20 : 2,
              transition: "left 0.2s",
            }} />
          </div>
          <span style={{ fontSize: 13, color: PALETTE.textDim }}>VAT Registered</span>
        </label>
        {form.vat_registered && (
          <div>
      ...
      <Card style={{ marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <Button variant="outline" onClick={() => downloadExport("pack")}>Download Accountant Pack (.zip)</Button>
